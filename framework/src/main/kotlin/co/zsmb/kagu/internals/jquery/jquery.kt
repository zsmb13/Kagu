...
internal external interface JQuery {
    ...
    fun after(func: (index: Number, html: String) -> dynamic /* String | Element | jquery.JQuery */): JQuery
    ...
    fun append(func: (index: Number, html: String) -> dynamic /* String | Element | jquery.JQuery */): JQuery
    ...
    fun before(func: (index: Number, html: String) -> dynamic /* String | Element | jquery.JQuery */): JQuery
    ...
    fun prepend(func: (index: Number, html: String) -> dynamic /* String | Element | jquery.JQuery */): JQuery
    ...
    fun replaceWith(func: () -> dynamic /* Element | jquery.JQuery */): JQuery
    fun text(): String
    ...
    fun wrap(func: (index: Number) -> dynamic /* String | jquery.JQuery */): JQuery
